                ...
                <div class="w-full md:w-1/2">
                    ...
                    <ul class="flex text-white m-0 p-0 gap-4">
                        <li class="opacity-60 hover:opacity-100 transition-all ease-linear duration-300">
                            <a href="https://www.instagram.com/maktab_sharif" rel="me nofollow" target="_blank">
                                <svg class="svg-inline--fa fa-instagram w-6" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="instagram" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                        ...
                        <li class="opacity-60 hover:opacity-100 transition-all ease-linear duration-300">
                            <a href="https://t.me/maktab_sharif" rel="me nofollow" target="_blank">
                                <svg class="svg-inline--fa fa-telegram-plane w-6" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="telegram-plane" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                        ...
                        <li class="opacity-60 hover:opacity-100 transition-all ease-linear duration-300">
                            <a href="https://www.linkedin.com/company/maktabsharif/" rel="me nofollow" target="_blank">
                                <svg class="svg-inline--fa fa-linkedin-in w-6" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="linkedin-in" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                        ...
                        <li class="opacity-60 hover:opacity-100 transition-all ease-linear duration-300">
                            <a href="https://twitter.com/maktab_sharif" rel="me nofollow" target="_blank">
                                <svg class="svg-inline--fa fa-twitter w-6" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
